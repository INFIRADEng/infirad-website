  ...
  return (
    <footer id="contact" className="border-t border-primary/10 bg-white py-16">
      <div className="container mx-auto grid gap-12 px-6 md:grid-cols-2 lg:grid-cols-[1.35fr_0.8fr_0.8fr]">
        ...
        <div>
          <h2 className="text-base font-bold text-primary"><span className="ar-content">تواصل</span><span className="en-content">Contact</span></h2>
          <div className="mt-5 grid gap-4 text-base text-foreground/70">
        ...
        <div>
          <h2 className="text-base font-bold text-primary"><span className="ar-content">المقر</span><span className="en-content">Location</span></h2>
          <p className="mt-5 flex items-start gap-3 text-base leading-relaxed text-foreground/70"><MapPin className="mt-1 h-5 w-5 shrink-0" /><span><span className="ar-content">الرياض، المملكة العربية السعودية</span><span className="en-content">Riyadh, Saudi Arabia</span></span></p>
        </div>
      </div>
      <div className="container mx-auto mt-14 flex flex-col gap-2 border-t border-primary/10 px-6 pt-7 text-sm font-bold text-foreground/45 sm:flex-row sm:items-center sm:justify-between">
